        ...
        <div className="about-content">
          ...
          <div className="profile-image">
            <picture>
              ...
              <source
                srcSet={`${process.env.PUBLIC_URL}/web-app-manifest-192x192.webp 192w,
                ${process.env.PUBLIC_URL}/web-app-manifest-512x512.webp 512w`}
                sizes="(max-width: 600px) 192px, 512px"
                type="image/webp"
              />
              {/* Fallback PNG images */}
              <source
                srcSet={`${process.env.PUBLIC_URL}/web-app-manifest-192x192.png 192w,
              ${process.env.PUBLIC_URL}/web-app-manifest-512x512.png 512w`}
                sizes="(max-width: 600px) 192px, 512px"
                type="image/png"
              />
              <img
